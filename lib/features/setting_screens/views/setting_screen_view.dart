...
class SettingScreenView extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> voices = [
    ...
    {"name": "Boy", "icon": Icons.child_care},
    {"name": "Girl", "icon": Icons.face_retouching_natural},
  ];
            ...
            children: [
                  ...
                  children: languages.map((lang) {
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Row(
                          children: [
                            Text(lang["flag"], style: TextStyle(fontSize: 20.sp)),
                            SizedBox(width: 6.w),
                            Text(
                              lang["name"],
                              style: GoogleFonts.outfit(
              ...
              Obx(
                  ...
                  children: voices.map((voice) {
                    bool isSelected = controller.selectedVoice.value == voice["name"];
                    return GestureDetector(
              ...
              AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.h),
                    _policy("1. All data is stored locally on this device only"),
